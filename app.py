...
def main():
    ...
    mileage = st.slider("Mileage", min_value=0, max_value=500000, value=0, step=1000, format='%d')
    ...
    usage_years = st.number_input("Usage Period (Years)", min_value=1, value= 1, step=1)
